...
| Node       | Description |
|------------|-------------|
| `nanocore` | The **head node** or **login/controller node**. This is where you log in, prepare jobs, submit them to the scheduler, and check on progress. |
| `nanogpu`  | [Currently down] The **compute node**, equipped with both CPUs and GPUs. This is where your ORCA jobs will actually run. |
